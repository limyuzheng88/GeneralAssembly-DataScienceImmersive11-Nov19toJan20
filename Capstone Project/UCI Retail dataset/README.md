...
3. Finally, for continued customer engagement, I ran an email marketing campaign with A/B testing, by sending marketing emails for complementary products (via Market Basket Analysis).  
